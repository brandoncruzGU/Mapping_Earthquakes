...
// Add a 2nd and 3rd layer group for the tectonic plate and major earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonicplates = new L.LayerGroup();
let majorquakes = new L.LayerGroup();


// Add a reference to the tectonic plates group and the major earthquakes group to the overlays object.
let overlays = {
